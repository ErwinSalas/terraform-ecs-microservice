...
resource "aws_security_group_rule" "example_ingress" {
  ...
  cidr_blocks              = var.source_security_groups_ids[each.key] != null ? null : each.value[0].cidr_blocks
  source_security_group_id = var.source_security_groups_ids[each.key] != null ? var.source_security_groups_ids[each.key] : null
}
