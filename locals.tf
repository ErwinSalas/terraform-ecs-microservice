...
locals {
  microservice_config = {
    "${var.api_gateway_key}" = {
      ...
      is_public      = true
      image          = "erwinsalas42/go-grpc-api-gateway:ecs"
      container_port = 3000
      host_port      = 3000
      cpu            = 256
      memory         = 512
    ...
    "${var.auth_service_key}" = {
      ...
      is_public        = false
      image            = "erwinsalas42/go-grpc-auth-svc:ecs"
    ...
    "${var.order_service_key}" = {
      ...
      is_public        = false
      image            = "erwinsalas42/go-grpc-order-svc:ecs"
     ...
     "${var.product_service_key}" = {
      ...
      is_public        = false
      image            = "erwinsalas42/go-grpc-product-svc:ecs"
